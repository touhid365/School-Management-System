...
<div class="container-fluid">
    ...
    <h6 class="m-0 font-weight-bold text-primary">Science Stream</h6>
    <?php
    // Generate buttons for each exam title specifically for Science stream
    $examResult->data_seek(0); // Reset the pointer to the start of the result set
...
<div class="btn-group mt-4" role="group" aria-label="Exam Titles - Arts">
    <h6 class="m-0 font-weight-bold text-primary">Arts Stream</h6>
    <?php
    // Generate buttons for each exam title specifically for Arts stream
    $examResult->data_seek(0); // Reset the pointer to the start of the result set
    while ($examRow = $examResult->fetch_assoc()) {
        $examTitle = $examRow['title'];
