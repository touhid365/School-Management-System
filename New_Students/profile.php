                            ...
                            <div class="col-lg-4">
                              <div class="card mb-4" style="box-shadow: 0 0 0 0.1rem rgba(78, 115, 223, 0.25);">
                                <div class="card-body text-center">
                                  ...
                                  echo '<img src="../images/school_4130952.png" class="rounded-circle img-fluid" style="width: 150px;">';
                                  }else{
                                  echo '<img src="uploads/'.$row['profile_image'].'" class="rounded-circle img-fluid" style="width: 150px;">';
                                  }
                                  ?>
                                  <h5 class="my-3">Student</h5>
                                  <!-- <p class="text-muted mb-1">Stream: <?php echo htmlspecialchars($row['stream']); ?></p> -->
                                  <p class="text-muted mb-4"> Reg No: <?php echo htmlspecialchars($row['registration_id']); ?></p>
                              ...
                              <div class="card mb-4" style="box-shadow: 0 0 0 0.1rem rgba(78, 115, 223, 0.25);">
                                <div class="card-body">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                      <p class="text-muted mb-0"><?php echo htmlspecialchars($row['m_status']); ?></p>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                      <p class="text-muted mb-0"><?php echo htmlspecialchars($row['nation']); ?></p>
                                    </div>
                                  </div>
                                </div>
                              </div>
